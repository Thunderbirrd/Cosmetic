...
(async () => {
    ...
    let defaultDate = await getMinDate(formatDate);
...
const showInstruction = (price) => {
    pInstruction.innerText = `Инструкция: Запись на процедуру строго по
        ...
        ФИО (например, Иванов Иван Иванович) отправьте на указанный в разделе "Контакты"
        номер в WhatsApp(можно сразу перейти в чат, нажав на него). Большое спасибо за запись!`.replace(/\n/g, " ")
